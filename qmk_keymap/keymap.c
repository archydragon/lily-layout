 ...
 */
[_NAVI] = LAYOUT( \
  DF(_MAIN),   KC_F1,   KC_F2,        KC_F3,    KC_F4,      KC_F5,                               DF(_NAVI), _______,  _______,  _______,  _______,  KC_PSCR, \
...
[_EXTRA] = LAYOUT( \
  DF(_MAIN), _______, _______, _______, _______, _______,                    DF(_EXTRA), _______, _______, _______, _______, _______, \
