 ...
 * |      |      |      | MWUp |      |      |                    |      |  M1  | MUp  |  M2  |      | MAc1 |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      | MWLt | MWDn | MWRt |      |-------.    ,-------|      | MLft | MDn  | MRgt |  M1  | MAc0 |
 * |------+------+------+------+------+------| MAIN  |    | LOCK  |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      |  M4  |  M3  |  M5  |      |      |
 * `-----------------------------------------/ Lshift/     \      \-----------------------------------------'
 *                   | LCtl | LAlt |  Meh | /[Space]/       \      \  |      |      |      |
...
[_MOUSE] = LAYOUT( \
    ...
    _______, _______, _______, KC_WH_U, _______, _______,                            _______, KC_BTN1, KC_MS_U, KC_BTN2, _______, KC_ACL1, \
    _______, _______, KC_WH_L, KC_WH_D, KC_WH_R, _______,                            _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN1, KC_ACL2, \
    _______, _______, _______, _______, _______, _______, DF(_COLEMAK),  DF(_MOUSE), _______, KC_BTN4, KC_BTN3, KC_BTN5, _______, _______, \
